$(function(){
    ...
    function Banner(){}
                ...
                banner.init({
                                ...
                                left_btn : "#left",
                                right_btn : "#right",
                                list_btn : "#btn_list li",
                                autoPlay : true
                            });
    // banner简介
    $(".drop-div em").mouseover(function(){
        $(".tag-content").css({
            display:"block"
        })
    })
    $(".drop-div em").mouseout(function(){
        $(".tag-content").css({
            display:"none"
        })
    }) 
    $(".tag-content").mouseover(function(){
        $(this).css({
            display:"block"
        })
    })  
    $(".tag-content").mouseout(function(){
        $(this).css({
            display:"none"
        })
    })  
    ...
    //  轮播图
    function popBanner(){}
                $.extend(popBanner.prototype , {
                    init:function(options){
                        /* 
                            {
                                item_list : "#temp-ul li",
                                // 非必填;
                                left_btn : "#pre",
                                right_btn : "#nex",
                                list_btn : "#nav-ul li",
                    ...
                    autoPlay:function(){
                        $("#pop-brand-main").mouseenter(function(){
                            clearInterval(this.bannerTimer)
                        }.bind(this))
        
                        $("#pop-brand-main").mouseleave(function(){
                            this.bannerTimer = setInterval(function(){
                                this.next();
                            }.bind(this) ,  2000)
                        }.bind(this)).trigger("mouseleave");
